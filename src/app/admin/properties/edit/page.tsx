    ...
    if (propertyId) {
      ...
      if (propertyData) {
        ...
        setFormData({
          ...
          basePrice: propertyData.price.toString(),
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Property ID Required</h2>
          <p className="text-gray-600">Please provide a property ID to edit.</p>
          <Link href="/admin/dashboard" className="text-red-500 hover:text-red-600 mt-4 inline-block">
            Back to Dashboard
          </Link>
        </div>
      </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">Update property information and media</p>
              </div>
                  ...
                  {images.map((image, index) => (
                    <div key={index} className="relative group">
                      <div className="relative h-24 rounded-lg overflow-hidden">
                        <Image
                          src={image.startsWith('data:') ? image : `${image}?auto=compress&cs=tinysrgb&w=200`}
